        ...
        @foreach($products as $product)
            ...
            <dialog id="detail-product-{{ $product->id }}" class="p-0 rounded w-[600px]">
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                    <button onclick="document.getElementById('detail-product-{{ $product->id }}').close()" type="button" class="text-gray-500 font-bold hover:bg-gray-100 rounded-lg border border-gray-200 text-sm px-5 py-2.5 hover:text-gray-900">
                        Sluiten
                    </button>
                </div>
            </dialog>
